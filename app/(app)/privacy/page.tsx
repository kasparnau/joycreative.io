      ...
      <Container>
        ...
        <ul className="list-disc list-outside mb-4">
          ...
          <li className="mb-2">
            <p>
              ...
              in this Agreement) refers to Joy Creative.
            </p>
          </li>
          <li className="mb-2">
            <p>
          ...
          <li className="mb-2">
            <p>
              <strong>Website</strong> refers to Joy Creative, accessible from
              <a
                href="https://joycreative.io"
                rel="external nofollow noopener"
                target="_blank"
                className="text-blue-500 hover:underline ml-1"
              >
                https://joycreative.io
              </a>
            </p>
          </li>
          <li className="mb-2">
        ...
        <ul className="list-disc list-outside mb-4">
          <li className="mb-2">
            ...
            <p className="ml-4">Type: Session Cookies</p>
            <p className="ml-4">Administered by: Us</p>
          ...
          <li className="mb-2">
            ...
            <p className="ml-4">Type: Persistent Cookies</p>
            <p className="ml-4">Administered by: Us</p>
            <p className="ml-4 mb-2">
        ...
        <h2 className="text-2xl font-semibold mb-3 mt-8">Contact Us</h2>
